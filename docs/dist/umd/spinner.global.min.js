...
}`;st=class{constructor(e={}){this.sources=new Map;this.textures=new Map;this.buffers=new Map;this.inner=new Oe(e)}setTexture(e,t){this.sources.set(e,t)}init(e){this.inner.init(e);let t=e.getContext("webgl2");this.gl=t,this.program=Hr(t),this.locations={aPos:t.getAttribLocation(this.program,"aPos"),aUV:t.getAttribLocation(this.program,"aUV"),aColor:t.getAttribLocation(this.program,"aColor"),uViewProj:t.getUniformLocation(this.program,"uViewProj"),uModel:t.getUniformLocation(this.program,"uModel"),uTexture:t.getUniformLocation(this.program,"uTexture"),uOpacity:t.getUniformLocation(this.program,"uOpacity")}}resize(){this.inner.resize()}textureFor(e){let t=this.textures.get(e);if(t)return t;let i=this.gl,r=i.createTexture();i.bindTexture(i.TEXTURE_2D,r),i.texImage2D(i.TEXTURE_2D,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,new Uint8Array([255,255,255,255])),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MAG_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE),this.textures.set(e,r);let o=a=>{!this.gl||this.textures.get(e)!==r||(this.gl.bindTexture(this.gl.TEXTURE_2D,r),this.gl.texImage2D(this.gl.TEXTURE_2D,0,this.gl.RGBA,this.gl.RGBA,this.gl.UNSIGNED_BYTE,a))},s=this.sources.get(e);if(typeof s=="string"){let a=new Image;a.onload=()=>o(a),a.src=s}else o(s);return r}buffersFor(e){let t=this.buffers.get(e);if(t)return t;let i=this.gl,r=this.locations,o=X(e),s=i.createVertexArray();i.bindVertexArray(s);let a=[],c=(u,p,d)=>{if(u<0)return;let h=i.createBuffer();a.push(h),i.bindBuffer(i.ARRAY_BUFFER,h),i.bufferData(i.ARRAY_BUFFER,p,i.STATIC_DRAW),i.enableVertexAttribArray(u),i.vertexAttribPointer(u,d,i.FLOAT,!1,0,0)};c(r.aPos,o.positions,3),c(r.aColor,o.colors,3),c(r.aUV,nt(e),2),i.bindVertexArray(null);let l={vao:s,buffers:a,count:o.count};return this.buffers.set(e,l),l}render(e){let t=[],i=[];for(let s of e.items)(this.sources.has(s.mesh)?i:t).push(s);if(this.inner.render(i.length?{...e,items:t}:e),!i.length)return;let r=this.gl,o=this.locations;if(!(!r||!this.program||!o)){r.useProgram(this.program),r.uniformMatrix4fv(o.uViewProj,!1,new Float32Array(e.viewProjection)),r.uniform1i(o.uTexture,0),r.activeTexture(r.TEXTURE0),r.enable(r.BLEND),r.blendFunc(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA),r.depthMask(!1);for(let s of i){let a=this.buffersFor(s.mesh);r.bindTexture(r.TEXTURE_2D,this.textureFor(s.mesh)),r.uniformMatrix4fv(o.uModel,!1,new Float32Array(s.model)),r.uniform1f(o.uOpacity,Wr(s.transparency)),r.bindVertexArray(a.vao),r.drawArrays(r.TRIANGLES,0,a.count)}r.depthMask(!0),r.disable(r.BLEND),r.bindVertexArray(null)}}destroy(){let e=this.gl;if(e){for(let t of this.textures.values())e.deleteTexture(t);for(let t of this.buffers.values()){e.deleteVertexArray(t.vao);for(let i of t.buffers)e.deleteBuffer(i)}this.program&&e.deleteProgram(this.program)}this.textures.clear(),this.buffers.clear(),this.sources.clear(),this.gl=void 0,this.program=void 0,this.locations=void 0,this.inner.destroy()}}});var on={};le(on,{Canvas2DTexturedRenderer:()=>ct});function Dn(n){if(n instanceof HTMLImageElement)return n.complete&&n.naturalWidth>0?{width:n.naturalWidth,height:n.naturalHeight}:void 0;if(n instanceof HTMLVideoElement)return n.readyState>=2?{width:n.videoWidth,height:n.videoHeight}:void 0;if(n instanceof SVGImageElement){let t=n.width.baseVal.value,i=n.height.baseVal.value;return t>0&&i>0?{width:t,height:i}:void 0}if(typeof VideoFrame<"u"&&n instanceof VideoFrame)return{width:n.displayWidth,height:n.displayHeight};let e=n;return e.width>0&&e.height>0?{width:e.width,height:e.height}:void 0}function jn(n,e,t,i){let[r,o,s]=t,[a,c,l]=i,u=r.x*(o.y-s.y)+o.x*(s.y-r.y)+s.x*(r.y-o.y);if(Math.abs(u)<1e-8)return;let p=(a.x*(o.y-s.y)+c.x*(s.y-r.y)+l.x*(r.y-o.y))/u,d=(a.x*(s.x-o.x)+c.x*(r.x-s.x)+l.x*(o.x-r.x))/u,h=(a.x*(o.x*s.y-s.x*o.y)+c.x*(s.x*r.y-r.x*s.y)+l.x*(r.x*o.y-o.x*r.y))/u,m=(a.y*(o.y-s.y)+c.y*(s.y-r.y)+l.y*(r.y-o.y))/u,b=(a.y*(s.x-o.x)+c.y*(r.x-s.x)+l.y*(o.x-r.x))/u,f=(a.y*(o.x*s.y-s.x*o.y)+c.y*(s.x*r.y-r.x*s.y)+l.y*(r.x*o.y-o.x*r.y))/u;n.save(),n.beginPath(),n.moveTo(a.x,a.y),n.lineTo(c.x,c.y),n.lineTo(l.x,l.y),n.closePath(),n.clip(),n.transform(p,m,d,b,h,f),n.drawImage(e,0,0),n.restore()}var ct,lt=U(()=>{"use strict";G();J();Ot();ct=class{constructor(e={}){this.sources=new Map;this.loaded=new Map;this.dpr=1;this.inner=new Se(e)}setTexture(e,t){if(this.sources.set(e,t),typeof t=="string"&&!this.loaded.has(t)){let i=new Image;i.src=t,this.loaded.set(t,i)}}init(e){this.inner.init(e),this.ctx=e.getContext("2d")??void 0}resize(e,t,i){this.dpr=i,this.inner.resize(e,t,i)}drawable(e){let t=this.sources.get(e);return typeof t=="string"?this.loaded.get(t):t}render(e){let t=e.items.filter(o=>{if(!this.sources.has(o.mesh))return!0;let s=this.drawable(o.mesh);return!s||!Dn(s)});this.inner.render({...e,items:t});let i=this.ctx;if(!i)return;i.setTransform(this.dpr,0,0,this.dpr,0,0);let r=new Map;for(let o of e.items){let s=this.drawable(o.mesh);if(!s)continue;let a=Dn(s);if(!a)continue;let c=r.get(o.mesh);if(!c){c=document.createElement("canvas"),c.width=a.width,c.height=a.height;let f=c.getContext("2d");if(!f)continue;f.drawImage(s,0,0,a.width,a.height),f.globalCompositeOperation="source-in",f.fillStyle=o.mesh.faces[0]?.color??"#ffffff",f.fillRect(0,0,a.width,a.height),r.set(o.mesh,c)}let u=o.mesh.vertices.map(f=>fe(o.model,f)).map(f=>{let y=Ue(e.viewProjection,f);return{x:(y.x*.5+.5)*e.width,y:(1-(y.y*.5+.5))*e.height}}),p=o.mesh.faces[0];if(!p||p.indices.length!==4)continue;let[d,h,m,b]=p.indices.map(f=>u[f]);i.globalAlpha=o.transparency?.mode==="one-sided"?F(o.transparency.opacity,.35):1,jn(i,c,[{x:0,y:a.height},{x:a.width,y:a.height},{x:a.width,y:0}],[d,h,m]),jn(i,c,[{x:0,y:a.height},{x:a.width,y:0},{x:0,y:0}],[d,m,b])}i.globalAlpha=1}destroy(){this.inner.destroy(),this.ctx=void 0,this.sources.clear(),this.loaded.clear()}}});var as={};le(as,{Camera:()=>be,Canvas2DTexturedRenderer:()=>ct,ChargedOrbAnimation:()=>Le,CompositeAnimation:()=>H,GhostTrainAnimation:()=>Ie,GridAssemblyAnimation:()=>Re,Light:()=>ye,Little3dEngine:()=>E,LittleTweenEngine:()=>dn,ObjectMotionAnimation:()=>me,ParticlesAnimation:()=>L,RocketLaunchAnimation:()=>Ve,SpinAnimation:()=>Zt,WebGLTexturedRenderer:()=>st,WebGPUTexturedRenderer:()=>rt,attachMaterial:()=>O,centerAndScaleMesh:()=>Vn,chargedOrb:()=>gi,circleMotion:()=>Ii,createSpinner:()=>Ni,cross:()=>T,crystalComet:()=>vi,cube:()=>te,cubeSphere:()=>Pn,cubic:()=>Pt,dot:()=>W,ease:()=>Je,easeInBack:()=>Gt,easeInBounce:()=>Yt,easeInCirc:()=>jt,easeInCubic:()=>se,easeInElastic:()=>Ht,easeInExpo:()=>kt,easeInOutBack:()=>Nt,easeInOutBounce:()=>qt,easeInOutCirc:()=>Ut,easeInOutCubic:()=>de,easeInOutElastic:()=>Xt,easeInOutExpo:()=>Dt,easeInOutQuad:()=>Rt,easeInOutQuart:()=>Ft,easeInOutQuint:()=>Vt,easeInOutSine:()=>Ct,easeInQuad:()=>oe,easeInQuart:()=>Ze,easeInQuint:()=>$e,easeInSine:()=>It,easeOutBack:()=>q,easeOutBounce:()=>xe,easeOutCirc:()=>Bt,easeOutCubic:()=>ee,easeOutElastic:()=>Wt,easeOutExpo:()=>Ee,easeOutQuad:()=>he,easeOutQuart:()=>wt,easeOutQuint:()=>_t,easeOutSine:()=>zt,easeTypes:()=>Qt,enterFromObjectDirection:()=>$t,expandToTriangles:()=>X,figureEightMotion:()=>ve,ghostTrain:()=>Ai,gridAssembly:()=>Oi,grow:()=>Or,icosphere:()=>Pe,leaveInObjectDirection:()=>Jt,linear:()=>Tt,monochromeStreak:()=>Ti,normalize:()=>g,octaSphere:()=>Sn,octahedron:()=>On,orderRenderItems:()=>Xe,parseObj:()=>ss,particleField:()=>Nn,planeMesh:()=>Qe,planeStarTrail:()=>Si,pulsingStarfield:()=>Pi,pyramid:()=>qe,quad:()=>pe,quadratic:()=>St,quartic:()=>Et,quintic:()=>Lt,rocketLaunch:()=>Ei,scale:()=>V,shineTexture:()=>re,shrink:()=>Tr,squareMotion:()=>pt,starSwarm:()=>Li,starTexture:()=>ie,streakTexture:()=>Ke,subtract:()=>S,tetrahedron:()=>Ye,transform:()=>He,uvSphere:()=>Tn,vec3:()=>fn,wanderMotion:()=>mt});function mn(n){return Number.isNaN(n)?0:Math.min(1,Math.max(0,n))}function Gi(n,e,t){return n+(e-n)*t}function Ni(n,e){if(!(n instanceof HTMLElement))throw new Error("3d-spinner: createSpinner requires a target HTMLElement.");let{animation:t}=e,i=e.type==="indeterminate";if(i&&e.periodMs!==void 0&&(!Number.isFinite(e.periodMs)||e.periodMs<=0))throw new RangeError("3d-spinner: periodMs must be a finite number greater than zero.");t.mount(n);let r=performance.now(),o=0,s=!1,a=!1,c=!1,l=!1,u=0,p=0,d=1/0;if(!i){let x=e;typeof x.progress=="number"&&(u=mn(x.progress),p=u),typeof x.timeout=="number"&&(d=Math.min(d,r+x.timeout)),x.until instanceof Date&&(d=Math.min(d,x.until.getTime()))}function h(x){if(!i)return x>=d&&(p=1),u=Gi(u,p,.12),Math.abs(p-u)<5e-4&&(u=p),u;let v=e,I=v.periodMs??2e3,P=(x-r)/I;if((v.loop??"bounce")==="restart")return P-Math.floor(P);let _=P-2*Math.floor(P/2);return _<=1?_:2-_}function m(x){if(s)return;let v=h(x);!c&&(i||v>0)&&(t.enter(x),c=!0),!l&&c&&!i&&v>=1&&p>=1&&(t.exit(x),l=!0);let I=i?v:p;if(t.render(x,{progress:v,targetProgress:I,indeterminate:i}),l&&t.isFinished()){b();return}o=requestAnimationFrame(m)}function b(){s||(s=!0,o&&cancelAnimationFrame(o),o=0)}function f(x){i||(p=mn(x))}function y(){if(!(s||l)){if(!c){b();return}t.exit(performance.now()),l=!0}}function M(){a||(a=!0,b(),t.destroy())}return o=requestAnimationFrame(m),{setProgress:f,stop:y,destroy:M}}G();var Hi={position:{x:0,y:0,z:4},fov:55*Math.PI/180,near:.1,far:100},be=class{constructor(e){this.options={...Hi,...e}}toView(e){let{position:t}=this.options;return fe(Ae(-t.x,-t.y,-t.z),e)}viewProjection(e){let{position:t,fov:i,near:r,far:o}=this.options,s=Ae(-t.x,-t.y,-t.z),a=yn(i,e,r,o);return z(a,s)}toScreen(e,t,i){return{x:(e.x*.5+.5)*t,y:(1-(e.y*.5+.5))*i}}};Ne();G();function O(n,e){if(e)for(let t of n.faces)t.material=e;return n}function He(n){return{position:n?.position??{x:0,y:0,z:0},rotation:n?.rotation??{x:0,y:0,z:0},scale:n?.scale??1}}J();Ne();var Ji=["#3b82f6","#8b5cf6","#ec4899","#f59e0b","#10b981","#ef4444"];function te(n=1,e=Ji,t){let i=n/2,r=[{x:-i,y:-i,z:i},{x:i,y:-i,z:i},{x:i,y:i,z:i},{x:-i,y:i,z:i},{x:-i,y:-i,z:-i},{x:i,y:-i,z:-i},{x:i,y:i,z:-i},{x:-i,y:i,z:-i}],o=[{indices:[0,1,2,3],color:e[0%e.length]},{indices:[5,4,7,6],color:e[1%e.length]},{indices:[3,2,6,7],color:e[2%e.length]},{indices:[4,5,1,0],color:e[3%e.length]},{indices:[1,5,6,2],color:e[4%e.length]},{indices:[4,0,3,7],color:e[5%e.length]}];return O({vertices:r,faces:o},t)}var er=["#3b82f6"];function pe(n=1,e=er,t){let i=n/2,r=[{x:-i,y:-i,z:0},{x:i,y:-i,z:0},{x:i,y:i,z:0},{x:-i,y:i,z:0}];return O({vertices:r,faces:[{indices:[0,1,2,3],color:e[0%e.length]}]},t)}var tr=["#3b82f6","#8b5cf6","#ec4899","#f59e0b"];function Ye(n=1,e=tr,t){let i=n/2,r=[{x:i,y:i,z:i},{x:i,y:-i,z:-i},{x:-i,y:i,z:-i},{x:-i,y:-i,z:i}],o=[{indices:[0,1,2],color:e[0%e.length]},{indices:[0,3,1],color:e[1%e.length]},{indices:[0,2,3],color:e[2%e.length]},{indices:[1,3,2],color:e[3%e.length]}];return O({vertices:r,faces:o},t)}var nr=["#3b82f6","#8b5cf6","#ec4899","#f59e0b","#10b981","#ef4444","#06b6d4","#eab308"];function On(n=1,e=nr,t){let i=n/2,r=[{x:i,y:0,z:0},{x:-i,y:0,z:0},{x:0,y:i,z:0},{x:0,y:-i,z:0},{x:0,y:0,z:i},{x:0,y:0,z:-i}],o=[{indices:[4,0,2],color:e[0%e.length]},{indices:[4,2,1],color:e[1%e.length]},{indices:[4,1,3],color:e[2%e.length]},{indices:[4,3,0],color:e[3%e.length]},{indices:[5,2,0],color:e[4%e.length]},{indices:[5,1,2],color:e[5%e.length]},{indices:[5,3,1],color:e[6%e.length]},{indices:[5,0,3],color:e[7%e.length]}];return O({vertices:r,faces:o},t)}var ir=["#3b82f6","#8b5cf6","#ec4899","#f59e0b","#10b981"];function qe(n=1,e=ir,t){let i=n/2,r=[{x:-i,y:-i,z:i},{x:i,y:-i,z:i},{x:i,y:-i,z:-i},{x:-i,y:-i,z:-i},{x:0,y:i,z:0}],o=[{indices:[0,3,2,1],color:e[0%e.length]},{indices:[4,0,1],color:e[1%e.length]},{indices:[4,1,2],color:e[2%e.length]},{indices:[4,2,3],color:e[3%e.length]},{indices:[4,3,0],color:e[4%e.length]}];return O({vertices:r,faces:o},t)}var rr=["#3b82f6","#8b5cf6","#ec4899","#f59e0b","#10b981","#ef4444"];function Tn(n=1,e=1,t=rr,i){let r=n/2,o=Math.max(1,Math.floor(e)),s=Math.max(4,o*4),a=Math.max(2,o*2),c=[{x:0,y:r,z:0}],l=(m,b)=>1+(m-1)*s+b;for(let m=1;m<a;m++){let b=Math.PI*m/a,f=r*Math.cos(b),y=r*Math.sin(b);for(let M=0;M<s;M++){let x=2*Math.PI*M/s;c.push({x:y*Math.cos(x),y:f,z:y*Math.sin(x)})}}let u=c.length;c.push({x:0,y:-r,z:0});let p=[],d=0,h=()=>t[d++%t.length];for(let m=0;m<s;m++)p.push({indices:[0,l(1,(m+1)%s),l(1,m)],color:h()});for(let m=1;m<a-1;m++)for(let b=0;b<s;b++){let f=(b+1)%s;p.push({indices:[l(m,b),l(m,f),l(m+1,f),l(m+1,b)],color:h()})}for(let m=0;m<s;m++)p.push({indices:[u,l(a-1,m),l(a-1,(m+1)%s)],color:h()});return O({vertices:c,faces:p},i)}$();var or=["#3b82f6","#8b5cf6","#ec4899","#f59e0b","#10b981","#ef4444"],k=(1+Math.sqrt(5))/2,sr=[{x:-1,y:k,z:0},{x:1,y:k,z:0},{x:-1,y:-k,z:0},{x:1,y:-k,z:0},{x:0,y:-1,z:k},{x:0,y:1,z:k},{x:0,y:-1,z:-k},{x:0,y:1,z:-k},{x:k,y:0,z:-1},{x:k,y:0,z:1},{x:-k,y:0,z:-1},{x:-k,y:0,z:1}],ar=[[0,11,5],[0,5,1],[0,1,7],[0,7,10],[0,10,11],[1,5,9],[5,11,4],[11,10,2],[10,7,6],[7,1,8],[3,9,4],[3,4,2],[3,2,6],[3,6,8],[3,8,9],[4,9,5],[2,4,11],[6,2,10],[8,6,7],[9,8,1]];function Pe(n=1,e=1,t=or,i){return O(Ge(sr,ar,n,e,t),i)}$();var cr=["#3b82f6","#8b5cf6","#ec4899","#f59e0b","#10b981","#ef4444"],lr=[{x:1,y:0,z:0},{x:-1,y:0,z:0},{x:0,y:1,z:0},{x:0,y:-1,z:0},{x:0,y:0,z:1},{x:0,y:0,z:-1}],ur=[[4,0,2],[4,2,1],[4,1,3],[4,3,0],[5,2,0],[5,1,2],[5,3,1],[5,0,3]];function Sn(n=1,e=1,t=cr,i){return O(Ge(lr,ur,n,e,t),i)}var pr=["#3b82f6","#8b5cf6","#ec4899","#f59e0b","#10b981","#ef4444"],hr=[{normal:[0,0,1],right:[1,0,0],up:[0,1,0]},{normal:[0,0,-1],right:[-1,0,0],up:[0,1,0]},{normal:[1,0,0],right:[0,0,-1],up:[0,1,0]},{normal:[-1,0,0],right:[0,0,1],up:[0,1,0]},{normal:[0,1,0],right:[1,0,0],up:[0,0,-1]},{normal:[0,-1,0],right:[1,0,0],up:[0,0,1]}];function Pn(n=1,e=1,t=pr,i){let r=n/2,o=Math.max(1,Math.floor(e)),s=[],a=[],c=0;for(let l of hr){let u=s.length;for(let d=0;d<=o;d++)for(let h=0;h<=o;h++){let m=-1+2*d/o,b=-1+2*h/o,f=l.normal[0]+m*l.right[0]+b*l.up[0],y=l.normal[1]+m*l.right[1]+b*l.up[1],M=l.normal[2]+m*l.right[2]+b*l.up[2],x=Math.hypot(f,y,M);s.push({x:f/x*r,y:y/x*r,z:M/x*r})}let p=(d,h)=>u+d*(o+1)+h;for(let d=0;d<o;d++)for(let h=0;h<o;h++)a.push({indices:[p(d,h),p(d+1,h),p(d+1,h+1),p(d,h+1)],color:t[c++%t.length]})}return O({vertices:s,faces:a},i)}var C=["#e0f2fe","#7dd3fc","#38bdf8","#f8fafc"];function Qe(n=C,e){return O({vertices:[{x:.9,y:0,z:0},{x:-.2,y:0,z:.82},{x:-.55,y:0,z:.16},{x:-.72,y:0,z:0},{x:-.55,y:0,z:-.16},{x:-.2,y:0,z:-.82},{x:-.08,y:.12,z:0},{x:-.08,y:-.1,z:0},{x:-.52,y:.38,z:0}],faces:[{indices:[6,1,0],color:n[0]??C[0]},{indices:[6,2,1],color:n[3]??C[3]},{indices:[6,3,2],color:n[1]??C[1]},{indices:[6,4,3],color:n[2]??C[2]},{indices:[6,5,4],color:n[3]??C[3]},{indices:[6,0,5],color:n[0]??C[0]},{indices:[7,0,1],color:n[1]??C[1]},{indices:[7,1,2],color:n[2]??C[2]},{indices:[7,2,3],color:n[1]??C[1]},{indices:[7,3,4],color:n[2]??C[2]},{indices:[7,4,5],color:n[1]??C[1]},{indices:[7,5,0],color:n[2]??C[2]},{indices:[3,6,8],color:n[0]??C[0]},{indices:[3,8,6],color:n[1]??C[1]}]},e)}function ne(n,e=96){let t=document.createElement("canvas");t.width=t.height=e;let i=t.getContext("2d");return i&&n(i),t}function En(n){n.save(),n.translate(48,48),n.fillStyle="#fff",n.beginPath();for(let e=0;e<10;e++){let t=e%2===0?43:16,i=e*Math.PI/5-Math.PI/2;n.lineTo(t*Math.cos(i),t*Math.sin(i))}n.closePath(),n.fill(),n.restore()}function ie(n={}){let e=Math.max(0,n.glow??0);return ne(t=>{e>0&&(t.save(),t.filter=`blur(${e}px)`,En(t),t.restore()),En(t)})}function re(){return ne(n=>{let e=n.createRadialGradient(48,48,1,48,48,46);e.addColorStop(0,"rgba(255,255,255,1)"),e.addColorStop(.08,"rgba(255,255,255,1)"),e.addColorStop(.22,"rgba(210,240,255,0.7)"),e.addColorStop(.55,"rgba(120,200,255,0.22)"),e.addColorStop(1,"rgba(80,160,255,0)"),n.fillStyle=e,n.fillRect(0,0,96,96)})}function Ke(){return ne(n=>{let e=n.createLinearGradient(5,0,91,0);e.addColorStop(0,"rgba(255,255,255,0)"),e.addColorStop(.7,"rgba(255,255,255,0.4)"),e.addColorStop(1,"rgba(255,255,255,1)"),n.strokeStyle=e,n.lineWidth=3.5,n.lineCap="round",n.beginPath(),n.moveTo(5,48),n.lineTo(91,48),n.stroke()})}$();J();G();function dr(n){let e=z(Be(n.rotation.z),z(je(n.rotation.y),De(n.rotation.x)));return z(Ae(n.position.x,n.position.y,n.position.z),z(e,bn(n.scale)))}var E=class{constructor(e={}){this.scene=[];this.cssWidth=0;this.cssHeight=0;this.ready=!1;this.generation=0;this.rafId=0;this.running=!1;this.camera=new be(e.camera),this.light=new ye(e.light),this.backend=e.backend??"canvas2d",this.background=e.background}async mount(e){let t=document.createElement("canvas");t.style.display="block",t.style.width="100%",t.style.height="100%",e.appendChild(t),this.canvas=t,this.observer=new ResizeObserver(()=>this.resize()),this.observer.observe(t),this.resize();let i=this.generation,r=()=>{this.canvas===t&&(this.observer?.disconnect(),this.observer=void 0,t.remove(),this.canvas=void 0)};try{let o=await An(this.backend,{background:this.background});if(i!==this.generation){o.destroy(),r();return}if(await o.init(t),i!==this.generation){o.destroy(),r();return}this.renderer=o,this.resize(),this.ready=!0}catch(o){throw r(),o}}add(e,t){let i={mesh:e,transform:He(t),transparency:t?.transparency,remove:()=>{let r=this.scene.indexOf(i);r>=0&&this.scene.splice(r,1)}};return this.scene.push(i),i}resize(){let e=this.canvas;if(!e)return;let t=window.devicePixelRatio||1;this.cssWidth=e.clientWidth||e.parentElement?.clientWidth||0,this.cssHeight=e.clientHeight||e.parentElement?.clientHeight||0,e.width=Math.max(1,Math.round(this.cssWidth*t)),e.height=Math.max(1,Math.round(this.cssHeight*t)),this.renderer?.resize(this.cssWidth,this.cssHeight,t)}render(){if(!this.ready||!this.renderer)return;let e=this.cssWidth,t=this.cssHeight;if(e===0||t===0)return;let i=this.scene.map(o=>({mesh:o.mesh,model:dr(o.transform),transparency:o.transparency})),r=this.camera.options.position;this.renderer.render({items:Xe(i,r),viewProjection:this.camera.viewProjection(e/t),eye:r,light:this.light.params,width:e,height:t})}start(){if(this.running)return;this.running=!0;let e=()=>{this.running&&(this.render(),this.rafId=requestAnimationFrame(e))};this.rafId=requestAnimationFrame(e)}stop(){this.running=!1,this.rafId&&cancelAnimationFrame(this.rafId),this.rafId=0}destroy(){this.generation++,this.ready=!1,this.stop(),this.observer?.disconnect(),this.observer=void 0,this.renderer?.destroy(),this.renderer=void 0,this.canvas?.remove(),this.canvas=void 0}};function A(n,e){return Number.isNaN(n)?0:e?n:Math.min(1,Math.max(0,n))}function Tt(n,e=!1){return A(n,e)}function St(n,e=!1){return oe(n,e)}function Pt(n,e=!1){return se(n,e)}function Et(n,e=!1){return Ze(n,e)}function Lt(n,e=!1){return $e(n,e)}function It(n,e=!1){let t=A(n,e);return 1-Math.cos(t*Math.PI/2)}function zt(n,e=!1){let t=A(n,e);return Math.sin(t*Math.PI/2)}function Ct(n,e=!1){let t=A(n,e);return-(Math.cos(Math.PI*t)-1)/2}function oe(n,e=!1){let t=A(n,e);return t*t}function he(n,e=!1){let t=A(n,e);return 1-(1-t)*(1-t)}function Rt(n,e=!1){let t=A(n,e);return t<.5?2*t*t:1-Math.pow(-2*t+2,2)/2}function se(n,e=!1){let t=A(n,e);return t*t*t}function ee(n,e=!1){let t=A(n,e);return 1-Math.pow(1-t,3)}function de(n,e=!1){let t=A(n,e);return t<.5?4*t*t*t:1-Math.pow(-2*t+2,3)/2}function Ze(n,e=!1){let t=A(n,e);return t*t*t*t}function wt(n,e=!1){let t=A(n,e);return 1-Math.pow(1-t,4)}function Ft(n,e=!1){let t=A(n,e);return t<.5?8*t*t*t*t:1-Math.pow(-2*t+2,4)/2}function $e(n,e=!1){let t=A(n,e);return t*t*t*t*t}function _t(n,e=!1){let t=A(n,e);return 1-Math.pow(1-t,5)}function Vt(n,e=!1){let t=A(n,e);return t<.5?16*t*t*t*t*t:1-Math.pow(-2*t+2,5)/2}function kt(n,e=!1){let t=A(n,e);return t===0?0:Math.pow(2,10*t-10)}function Ee(n,e=!1){let t=A(n,e);return t===1?1:1-Math.pow(2,-10*t)}function Dt(n,e=!1){let t=A(n,e);return t===0?0:t===1?1:t<.5?Math.pow(2,20*t-10)/2:(2-Math.pow(2,-20*t+10))/2}function jt(n,e=!1){let t=A(n,e);return 1-Math.sqrt(1-Math.pow(t,2))}function Bt(n,e=!1){let t=A(n,e);return Math.sqrt(1-Math.pow(t-1,2))}function Ut(n,e=!1){let t=A(n,e);return t<.5?(1-Math.sqrt(1-Math.pow(2*t,2)))/2:(Math.sqrt(1-Math.pow(-2*t+2,2))+1)/2}function Gt(n,e=!1){let t=A(n,e),i=1.70158;return(i+1)*t*t*t-i*t*t}function q(n,e=!1){let t=A(n,e),i=1.70158;return 1+(i+1)*Math.pow(t-1,3)+i*Math.pow(t-1,2)}function Nt(n,e=!1){let t=A(n,e),r=1.70158*1.525;return t<.5?Math.pow(2*t,2)*((r+1)*2*t-r)/2:(Math.pow(2*t-2,2)*((r+1)*(t*2-2)+r)+2)/2}function Ht(n,e=!1){let t=A(n,e),i=2*Math.PI/3;return t===0?0:t===1?1:-Math.pow(2,10*t-10)*Math.sin((t*10-10.75)*i)}function Wt(n,e=!1){let t=A(n,e),i=2*Math.PI/3;return t===0?0:t===1?1:Math.pow(2,-10*t)*Math.sin((t*10-.75)*i)+1}function Xt(n,e=!1){let t=A(n,e),i=2*Math.PI/4.5;return t===0?0:t===1?1:t<.5?-(Math.pow(2,20*t-10)*Math.sin((20*t-11.125)*i))/2:Math.pow(2,-20*t+10)*Math.sin((20*t-11.125)*i)/2+1}function Yt(n,e=!1){let t=A(n,e);return 1-xe(1-t,!0)}function xe(n,e=!1){let t=A(n,e),i=7.5625,r=2.75;return t<1/r?i*t*t:t<2/r?(t-=1.5/r,i*t*t+.75):t<2.5/r?(t-=2.25/r,i*t*t+.9375):(t-=2.625/r,i*t*t+.984375)}function qt(n,e=!1){let t=A(n,e);return t<.5?(1-xe(1-2*t,!0))/2:(1+xe(2*t-1,!0))/2}var Qt={linear:Tt,quadratic:St,cubic:Pt,quartic:Et,quintic:Lt,easeInSine:It,easeOutSine:zt,easeInOutSine:Ct,easeInQuad:oe,easeOutQuad:he,easeInOutQuad:Rt,easeInCubic:se,easeOutCubic:ee,easeInOutCubic:de,easeInQuart:Ze,easeOutQuart:wt,easeInOutQuart:Ft,easeInQuint:$e,easeOutQuint:_t,easeInOutQuint:Vt,easeInExpo:kt,easeOutExpo:Ee,easeInOutExpo:Dt,easeInCirc:jt,easeOutCirc:Bt,easeInOutCirc:Ut,easeInBack:Gt,easeOutBack:q,easeInOutBack:Nt,easeInElastic:Ht,easeOutElastic:Wt,easeInOutElastic:Xt,easeInBounce:Yt,easeOutBounce:xe,easeInOutBounce:qt};function Je(n,e,t=!1){return Qt[n](e,t)}function mr(n={}){return{popDurationMs:n.popDurationMs??500,overextend:n.overextend??.2,startSnapRatio:n.startSnapRatio??.2,loadingText:n.loadingText===void 0?"loading":n.loadingText,doneText:n.doneText??"done",doneFadeDurationMs:n.doneFadeDurationMs??2e3,removeOnComplete:n.removeOnComplete??!1}}function Kt(n,e,t){return t<=0?1:Math.min(1,Math.max(0,(n-e)/t))}var et=class{constructor(e={}){this.phase="idle";this.phaseStart=0;this.activeProgress=0;this.popTarget=0;this.doneFadeStart=0;this.options=mr(e)}enter(e){this.phase==="idle"&&(this.phase="startPop",this.phaseStart=e,this.activeProgress=0,this.popTarget=0)}exit(e){this.phase!=="startPop"&&this.phase!=="active"||(this.phase="endPop",this.phaseStart=e)}isFinished(){return this.phase==="finished"}update(e,t,i){let{popDurationMs:r,overextend:o,startSnapRatio:s,loadingText:a,doneText:c,doneFadeDurationMs:l,removeOnComplete:u}=this.options,p=i??t;(this.phase==="startPop"||this.phase==="active")&&(this.activeProgress=t,this.phase==="startPop"&&(this.popTarget=Math.max(this.popTarget,p,t)));let d=0,h=null,m=0,b=!1;if(this.phase==="startPop"){let f=Kt(e,this.phaseStart,r),y=this.popTarget*(1+o);if(f<s){let M=s>0?f/s:1;d=y*Ee(M)}else{let M=s<1?(f-s)/(1-s):1;d=y+(this.activeProgress-y)*ee(M)}f>=1&&(this.phase="active")}else if(this.phase==="active")d=this.activeProgress;else if(this.phase==="endPop"){let f=Kt(e,this.phaseStart,r),y=1+o;f<.5?d=1+(y-1)*he(f*2):d=y*(1-oe((f-.5)*2)),f>=1&&(this.phase="done",this.doneFadeStart=e,d=0)}if(this.phase==="startPop"||this.phase==="active")a!==!1&&(h=a,m=.65);else if(this.phase==="endPop")h=c,m=.65;else if(this.phase==="done"){let f=Kt(e,this.doneFadeStart,l);f>=1?(u&&(b=!0),this.phase="finished"):(h=c,m=.65*(1-f))}return{scale:d,text:h,textOpacity:m,hidden:b}}};var fr=["position:absolute","inset:0","display:flex","align-items:center","justify-content:center","pointer-events:none","font:600 1.1rem/1.2 system-ui,sans-serif","letter-spacing:0.06em","text-transform:lowercase","color:rgba(255,255,255,0.65)","z-index:1"].join(";");function br(n){return n?typeof n=="function"?n():n:te()}function yr(n,e){if(e===void 0||Array.isArray(e)&&e.length===0)return n;let t=Array.isArray(e)?i=>e[i%e.length]:()=>e;return{vertices:n.vertices,faces:n.faces.map((i,r)=>({...i,color:t(r)}))}}function xr(n,e){return e?{vertices:n.vertices,faces:n.faces.map(t=>({...t,material:e}))}:n}var Zt=class{constructor(e={}){this.exited=!1;this.mesh=xr(yr(br(e.shape),e.color),e.material),this.spinX=e.spinX??7e-4,this.spinY=e.spinY??.0011,this.backend=e.backend,this.transparency=e.transparency,this.progress=e.progressAnimation?new et(e.progressAnimation):void 0}mount(e){e.style.position||(e.style.position="relative");let t=new E({backend:this.backend,camera:{position:{x:0,y:0,z:2.8}}});if(this.handle=t.add(this.mesh,{transparency:this.transparency}),this.engine=t,t.mount(e).catch(i=>{e.textContent=i instanceof Error?i.message:String(i)}),this.progress){let i=document.createElement("div");i.style.cssText=fr,i.setAttribute("aria-hidden","true"),i.hidden=!0,e.appendChild(i),this.label=i}}enter(e){this.progress?.enter(e)}exit(e){this.exited=!0,this.progress?.exit(e)}isFinished(){return this.progress?this.progress.isFinished():this.exited}render(e,t){if(!this.engine||!this.handle)return;let i=this.handle.transform.rotation;if(i.x=e*this.spinX,i.y=e*this.spinY,this.progress){let r=this.progress.update(e,t.progress,t.targetProgress);this.handle.transform.scale=r.hidden?0:r.scale,this.applyLabel(r)}else this.handle.transform.scale=1;this.engine.render()}destroy(){this.label?.remove(),this.label=void 0,this.engine?.destroy(),this.engine=void 0,this.handle=void 0}applyLabel(e){if(this.label){if(e.hidden||e.text==null){this.label.hidden=!0,this.label.textContent="";return}this.label.hidden=!1,this.label.textContent=e.text,this.label.style.opacity=String(e.textOpacity)}}};var Mr=["position:absolute","inset:0","display:flex","align-items:center","justify-content:center","pointer-events:none","font:700 1.6rem/1 system-ui,sans-serif","letter-spacing:0.02em","color:rgba(255,255,255,0.9)","text-shadow:0 1px 10px rgba(0,0,0,0.6)","z-index:1"].join(";");function Q(n,e,t,i,r){if(e===1/0)return 0;let o=t<=0?1:Math.max(0,Math.min(1,(n-e)/t)),s=i===1/0?1:r<=0?0:Math.max(0,Math.min(1,1-(n-i)/r));return Math.min(o,s)}function K(n,e){var i;let t=document.createElement("div");return t.style.cssText=Mr,t.setAttribute("role","status"),typeof e=="string"?t.textContent=e:e&&((i=e.style).pointerEvents||(i.pointerEvents="auto"),t.appendChild(e)),n.appendChild(t),{container:t,setText(r){typeof e!="object"&&(t.textContent=r)},setOpacity(r){t.style.opacity=String(r)}}}G();function Ln(n,e){return{x:n.x+e.x,y:n.y+e.y,z:n.z+e.z}}function tt(n,e){return{x:n.x*e,y:n.y*e,z:n.z*e}}function In(n){return Math.hypot(n.x,n.y,n.z)}function gr(n){let e=In(n);return e<1e-6?{x:1,y:0,z:0}:tt(n,1/e)}function vr(n,e){return gr(e??n.direction??n.velocity??{x:1,y:0,z:0})}function Ar(n){let t=n-1;return 1+(1.70158+1)*t*t*t+1.70158*t*t}function zn(n,e,t){let i=n.velocity?In(n.velocity):0;if(n.velocity&&i>1e-6&&!e.direction)return n.velocity;let r=e.distance??3.5;return tt(vr(n,e.direction),r/t)}function $t(n={}){return e=>{let t=Math.max(1,e.durationMs),i=zn(e,n,t),r=t-e.elapsedMs;return{position:Ln(e.position,tt(i,-r))}}}function Jt(n={}){return e=>{let t=Math.max(1,e.durationMs),i=zn(e,n,t);return{position:Ln(e.position,tt(i,e.elapsedMs))}}}function Or(){return n=>({size:(n.size??1)*Ar(n.delta)})}function Tr(){return n=>({size:(n.size??1)*(1-n.delta*n.delta)})}var Sr={x:0,y:1,z:0},Pr=2100,Er=2100,Lr=26,Cn=.7,Ir=.12,en=8,zr={"+x":n=>n,"-x":n=>({x:-n.x,y:n.y,z:-n.z}),"+z":n=>({x:n.z,y:n.y,z:-n.x}),"-z":n=>({x:-n.z,y:n.y,z:n.x}),"+y":n=>({x:n.y,y:-n.x,z:n.z}),"-y":n=>({x:-n.y,y:n.x,z:n.z})};function Cr(n,e){return{x:n.x+e.x,y:n.y+e.y,z:n.z+e.z}}function Rr(n){return typeof n=="function"?n():n}function wr(n,e){return e===void 0?n:{vertices:n.vertices,faces:n.faces.map(t=>({...t,color:e}))}}function Fr(n,e){if(e==="+x")return n;let t=zr[e];return{vertices:n.vertices.map(t),faces:n.faces}}function Vn(n,e){let t=1/0,i=1/0,r=1/0,o=-1/0,s=-1/0,a=-1/0;for(let h of n.vertices)t=Math.min(t,h.x),i=Math.min(i,h.y),r=Math.min(r,h.z),o=Math.max(o,h.x),s=Math.max(s,h.y),a=Math.max(a,h.z);let c=(t+o)/2,l=(i+s)/2,u=(r+a)/2,p=Math.max(o-t,s-i,a-r)||1,d=e/p;return{vertices:n.vertices.map(h=>({x:(h.x-c)*d,y:(h.y-l)*d,z:(h.z-u)*d})),faces:n.faces}}function _r(n,e){let t=g(n),i=T(t,Sr);Math.hypot(i.x,i.y,i.z)<1e-4&&(i={x:0,y:0,z:1}),i=g(i);let r=T(i,t),o=Cr(V(r,Math.cos(e)),V(i,Math.sin(e))),s=g(T(t,o));return{x:Math.atan2(T(s,t).z,s.z),y:Math.asin(Math.max(-1,Math.min(1,-t.z))),z:Math.atan2(t.y,t.x)}}function Rn(n,e,t){return z(Be(t),z(je(e),De(n)))}function Vr(n){return Math.hypot(n[0],n[1])>1e-6?{x:Math.atan2(n[9],n[10]),y:Math.asin(Math.max(-1,Math.min(1,-n[8]))),z:Math.atan2(n[4],n[0])}:{x:Math.atan2(-n[6],n[5]),y:Math.asin(Math.max(-1,Math.min(1,-n[8]))),z:0}}function kr(n,e){return Vr(z(Rn(n.x,n.y,n.z),Rn(e.x,e.y,e.z)))}function Dr(n){return Math.max(0,Math.min(1,n))}function wn(n,e){return V(S(n.positionAt(e+1),n.positionAt(e-1)),.5)}function Fn(n,e){return Math.hypot(n.x,n.y,n.z)>1e-6?g(n):e}function _n(n,e,t){return n?typeof n=="function"?{transition:n,durationMs:t}:{transition:n.transition,durationMs:Math.max(0,n.durationMs??t)}:{transition:e,durationMs:t}}var me=class{constructor(e){this.handles=[];this.banks=[];this.headings=[];this.started=!1;this.finished=!1;this.introStart=0;this.outroStart=1/0;this.outroPosition={x:0,y:0,z:0};this.outroVelocity={x:0,y:0,z:0};this.outroDirection={x:1,y:0,z:0};let t=Vn(Rr(e.mesh),e.size??1),i=Fr(t,e.facing??"+x");this.mesh=wr(i,e.color),this.motion=e.motion,this.backend=e.backend,this.transparency=e.transparency,this.labelContent=e.label,this.fadeLabel=e.fadeLabel??!0,this.tailCount=Math.max(0,Math.floor(e.tail?.count??0)),this.tailGap=Math.max(0,e.tail?.gapMs??0),this.intro=_n(e.intro,$t(),Pr),this.outro=_n(e.outro,Jt(),Er);let r=e.rotation;this.rotationOffset={x:r?.x??0,y:r?.y??0,z:r?.z??0},this.rotationSpin={x:r?.spinX??0,y:r?.spinY??0,z:r?.spinZ??0},this.hasExtraRotation=this.rotationOffset.x!==0||this.rotationOffset.y!==0||this.rotationOffset.z!==0||this.rotationSpin.x!==0||this.rotationSpin.y!==0||this.rotationSpin.z!==0}mount(e){e.style.position||(e.style.position="relative");let t=new E({backend:this.backend,camera:{position:{x:0,y:0,z:3}}});for(let i=0;i<=this.tailCount;i++)this.handles.push(t.add(this.mesh,{transparency:this.transparency})),this.banks.push(0),this.headings.push({x:1,y:0,z:0});this.engine=t,t.mount(e).catch(i=>{e.textContent=i instanceof Error?i.message:String(i)}),this.label=K(e,this.labelContent),this.fadeLabel&&this.label.setOpacity(0)}enter(e){this.started||(this.started=!0,this.introStart=e)}exit(e){!this.started||this.outroStart!==1/0||(this.outroPosition=this.motion.positionAt(e),this.outroVelocity=wn(this.motion,e),this.outroDirection=Fn(this.outroVelocity,this.headings[0]),this.outroStart=e)}isFinished(){return this.finished}get outroDurationMs(){return this.outro.durationMs}trailEmitter(){return{positionAt:e=>this.sampleAt(e)?.position??this.motion.positionAt(e)}}render(e,t){if(!(!this.engine||!this.label)){this.outroStart!==1/0&&e>=this.outroStart+this.outro.durationMs+this.tailCount*this.tailGap&&(this.finished=!0);for(let i=0;i<this.handles.length;i++){let r=this.handles[i].transform,o=e-i*this.tailGap,s=this.sampleAt(o);if(!s){r.scale=0;continue}r.scale=s.size;let a=s.orientation;if(!a){let c=S(this.positionAt(o+en)??s.position,s.position);Math.hypot(c.x,c.y,c.z)>1e-5&&(this.headings[i]=g(c));let l=this.aheadAt(o)??this.headings[i],u=Math.max(-Cn,Math.min(Cn,T(this.headings[i],l).y*Lr));this.banks[i]+=(u-this.banks[i])*Ir,a=_r(this.headings[i],this.banks[i])}this.hasExtraRotation&&(a=kr(a,{x:this.rotationOffset.x+this.rotationSpin.x*o,y:this.rotationOffset.y+this.rotationSpin.y*o,z:this.rotationOffset.z+this.rotationSpin.z*o})),r.position.x=s.position.x,r.position.y=s.position.y,r.position.z=s.position.z,r.rotation.x=a.x,r.rotation.y=a.y,r.rotation.z=a.z}this.label.setText(t.indeterminate?typeof this.labelContent=="string"?this.labelContent:"":`${Math.round(t.progress*100)}%`),this.fadeLabel&&this.label.setOpacity(Q(e,this.started?this.introStart:1/0,this.intro.durationMs,this.outroStart,this.outro.durationMs)),this.engine.render()}}destroy(){this.label?.container.remove(),this.label=void 0,this.engine?.destroy(),this.engine=void 0,this.handles.length=0}aheadAt(e){let t=this.positionAt(e+en),i=this.positionAt(e+2*en);if(!t||!i)return;let r=S(i,t);if(!(Math.hypot(r.x,r.y,r.z)<=1e-5))return g(r)}positionAt(e){return this.sampleAt(e)?.position}sampleAt(e){if(!(!this.started||e<this.introStart)){if(e<this.introStart+this.intro.durationMs)return this.transitionSample("intro",e,this.intro,this.introStart);if(this.outroStart!==1/0){if(e>this.outroStart+this.outro.durationMs)return;if(e>=this.outroStart)return this.transitionSample("outro",e,this.outro,this.outroStart)}return{position:this.motion.positionAt(e),size:1}}}transitionSample(e,t,i,r){let o=Math.max(0,t-r),s=i.durationMs===0?1:Dr(o/i.durationMs),a=this.transitionInput(e,s,o,i.durationMs,r),c=i.transition(a);return this.applyTransitionOutput(a,c,e,t)}transitionInput(e,t,i,r,o){if(e==="intro"){let s=o+r,a=wn(this.motion,s);return{delta:t,position:this.motion.positionAt(s),direction:Fn(a,{x:1,y:0,z:0}),velocity:a,size:1,durationMs:r,elapsedMs:i,phase:e}}return{delta:t,position:this.outroPosition,direction:this.outroDirection,velocity:this.outroVelocity,size:1,durationMs:r,elapsedMs:i,phase:e}}applyTransitionOutput(e,t,i,r){return{position:t.position??(i==="intro"?this.motion.positionAt(r):e.position),size:t.size??e.size??1,orientation:t.orientation}}};var Xr=["#fde047","#fb923c","#f472b6","#60a5fa"],Gn=.15,Yr=.6;function Me(n,e,t){let i=(n^Math.imul(e+1,2654435769)^Math.imul(t+1,2246822507))>>>0;return i=Math.imul(i^i>>>16,73244475),i=Math.imul(i^i>>>16,73244475),i^=i>>>16,(i>>>0)/4294967296}function Bn(n,e,t){let i=Math.max(0,Math.min(1,(t-n)/(e-n)));return i*i*(3-2*i)}function Un(n,e){if(!Number.isFinite(n)||n<=0)throw new RangeError(`3d-spinner: ${e} must be a finite number greater than zero.`);return n}function qr(n){let e=g(n),t=Math.abs(e.y)<.99?{x:0,y:1,z:0}:{x:1,y:0,z:0},i=g(T(t,e));return{d:e,right:i,up:T(e,i)}}function Nn(n={}){let e=Un(n.rate??20,"rate"),t=Un(n.lifeMs??1800,"lifeMs"),i=n.size??.16,r=n.speed??.6,o=n.gravity,s=n.spread??.5,a=Math.max(0,Math.min(1,n.opacity??.9)),c=n.spin??.002,l=n.alignToMotion??!1,u=n.seed??1,p=n.direction&&qr(n.direction),d=1e3/e,h=m=>{let b=Me(u,m,0),f=2*Math.PI*Me(u,m,1);if(!p){let P=2*b-1,_=Math.sqrt(Math.max(0,1-P*P));return{x:_*Math.cos(f),y:_*Math.sin(f),z:P}}let y=1-b*(1-Math.cos(s)),M=Math.sqrt(Math.max(0,1-y*y)),{d:x,right:v,up:I}=p;return{x:x.x*y+(v.x*Math.cos(f)+I.x*Math.sin(f))*M,y:x.y*y+(v.y*Math.cos(f)+I.y*Math.sin(f))*M,z:x.z*y+(v.z*Math.cos(f)+I.z*Math.sin(f))*M}};return{maxLive:Math.ceil(t*e/1e3)+1,spawnGapMs:d,lifeMs:t,sample(m,b){if(m<0)return;let f=b-m*d;if(f<0||f>=t)return;let y=f/1e3,M=h(m),x=r*(.6+.8*Me(u,m,2)),v=x*y,I=o?.5*y*y:0,P=f/t,_=l?Math.atan2(M.y*x+(o?.y??0)*y,M.x*x+(o?.x??0)*y):2*Math.PI*Me(u,m,3)+(2*Me(u,m,4)-1)*c*f;return{position:{x:M.x*v+(o?o.x*I:0),y:M.y*v+(o?o.y*I:0),z:M.z*v+(o?o.z*I:0)},roll:_,size:i*(.7+.6*Me(u,m,5)),opacity:a*Bn(0,Gn,P)*(1-Bn(Yr,1,P))}}}}var L=class{constructor(e={}){this.handles=[];this.fades=[];this.enterAt=1/0;this.exitAt=1/0;this.finished=!1;this.field=Nn(e),this.colors=e.colors??Xr,this.backend=e.backend,this.texture=e.texture,this.labelContent=e.label,this.fadeLabel=e.fadeLabel??!0,this.emitter=e.emitter,this.outroMs=Math.max(0,e.outroMs??0)}mount(e){e.style.position||(e.style.position="relative");let t=this.colors.map(s=>pe(1,[s])),i=this.texture,r=i?async s=>{let a=this.backend==="webgpu"?new(await Promise.resolve().then(()=>(ot(),nn))).WebGPUTexturedRenderer(s):this.backend==="webgl"?new(await Promise.resolve().then(()=>(at(),rn))).WebGLTexturedRenderer(s):new(await Promise.resolve().then(()=>(lt(),on))).Canvas2DTexturedRenderer(s);for(let c of t)a.setTexture(c,i);return a}:this.backend,o=new E({backend:r,camera:{position:{x:0,y:0,z:3}},light:{intensity:0,ambient:1}});for(let s=0;s<this.field.maxLive;s++){let a={mode:"one-sided",opacity:0};this.fades.push(a),this.handles.push(o.add(t[s%t.length],{scale:0,transparency:a}))}this.engine=o,o.mount(e).catch(s=>{e.textContent=s instanceof Error?s.message:String(s)}),this.label=K(e,this.labelContent),this.fadeLabel&&this.label.setOpacity(0)}enter(e){this.enterAt===1/0&&(this.enterAt=e)}exit(e){this.exitAt===1/0&&(this.exitAt=e)}isFinished(){return this.finished}render(e,t){if(!(!this.engine||!this.label)){this.exitAt!==1/0&&e>=this.exitAt+this.outroMs+this.field.lifeMs&&(this.finished=!0);for(let i of this.handles)i.transform.scale=0;if(this.enterAt!==1/0){let i=e-this.enterAt,r=this.field.spawnGapMs,o=Math.max(0,Math.ceil((i-this.field.lifeMs)/r)),s=Math.floor(i/r);this.exitAt!==1/0&&(s=Math.min(s,Math.floor((this.exitAt-this.enterAt+this.outroMs)/r))),o=Math.max(o,s-this.field.maxLive+1);for(let a=o;a<=s;a++){let c=this.field.sample(a,i);if(!c)continue;let l=a%this.handles.length,u=this.handles[l].transform,p=this.emitter?.positionAt(this.enterAt+a*r);u.position.x=c.position.x+(p?.x??0),u.position.y=c.position.y+(p?.y??0),u.position.z=c.position.z+(p?.z??0),u.rotation.z=c.roll,u.scale=c.size,this.fades[l].opacity=c.opacity}}this.label.setText(t.indeterminate?typeof this.labelContent=="string"?this.labelContent:"":`${Math.round(t.progress*100)}%`),this.fadeLabel&&this.label.setOpacity(Q(e,this.enterAt,this.field.lifeMs*Gn,this.exitAt,this.field.lifeMs)),this.engine.render()}}destroy(){this.label?.container.remove(),this.label=void 0,this.engine?.destroy(),this.engine=void 0,this.handles.length=0,this.fades.length=0}};var D=10,Qr=3,Hn=.76,Kr=.36,Zr={mode:"two-sided",frontOpacity:.68,backOpacity:.87},Wn=1.2,Xn=.8,sn=Math.PI*2,$r=500,Jr=550,eo=2.5,to=250,an=250,cn=1300,Kn=600,Zn=45,Yn=Kn+(D-1)*Zn+150,no=420,io={x:0,y:0,z:50},qn={specular:[1,1,1],shininess:28},ro=["#67e8f9","#22d3ee","#0ea5e9","#38bdf8","#7dd3fc"],Qn=[["#e0f2fe","#bae6fd","#7dd3fc"],["#c7d2fe","#a5b4fc","#818cf8"],["#a5f3fc","#67e8f9","#22d3ee"]];function ut(n){return Math.max(0,Math.min(1,n))}var Le=class{constructor(e={}){this.minis=[];this.blends=new Array(D).fill(0);this.offsets=new Array(D).fill(0);this.enterAt=1/0;this.exitAt=1/0;this.allOutAt=1/0;this.lastNow=0;this.finished=!1;this.orbitPeriodMs=e.orbitPeriodMs??6e3,this.backend=e.backend}mount(e){e.style.position||(e.style.position="relative");let t=new E({backend:this.backend,camera:{position:{x:0,y:0,z:Qr}}});this.center=t.add(Pe(1,2,ro,qn),{scale:0});for(let i=0;i<D;i++){let r=Pe(1,1,Qn[i%Qn.length],qn);this.minis.push(t.add(r,{scale:0,transparency:{...Zr}}))}this.engine=t,t.mount(e).catch(i=>{e.textContent=i instanceof Error?i.message:String(i)})}enter(e){this.enterAt===1/0&&(this.enterAt=e)}exit(e){this.exitAt===1/0&&(this.exitAt=e)}isFinished(){return this.finished}get outroEmitMs(){return an+cn+Yn}satelliteEmitter(e){return{positionAt:t=>{let i=[];for(let o=0;o<D;o++){let s=this.miniSample(o,t);s&&i.push(s.position)}if(i.length===0)return io;let r=Math.abs(Math.floor(t/e))%i.length;return i[r]}}}render(e,t){if(!this.engine||!this.center)return;if(this.enterAt===1/0){this.center.transform.scale=0;for(let o of this.minis)o.transform.scale=0;this.engine.render();return}let i=this.lastNow===0?16:Math.min(50,e-this.lastNow);this.lastNow=e,this.updateBlends(i,t.progress,e),this.updateSpread(i);let r=e-this.enterAt;this.center.transform.scale=this.centerScale(e,r),this.center.transform.rotation.x=r*2e-4,this.center.transform.rotation.y=r*5e-4;for(let o=0;o<D;o++){let s=this.minis[o].transform,a=this.miniSample(o,e);if(!a){s.scale=0;continue}s.position.x=a.position.x,s.position.y=a.position.y,s.position.z=a.position.z,s.scale=a.scale,s.rotation.y=r*.0012}this.engine.render()}destroy(){this.engine?.destroy(),this.engine=void 0,this.center=void 0,this.minis.length=0}updateBlends(e,t,i){let r=this.exitAt!==1/0,o=r?D:Math.min(D,Math.floor(t*D+1e-9)),s=e/Jr*(r?eo:1);for(let a=0;a<D;a++){let c=a<o?1:0,l=this.blends[a];c>l&&(a===0||this.blends[a-1]>=.6)?(this.blends[a]=Math.min(1,l+s),l===0&&(this.offsets[a]=this.slotAngle(a))):c<l&&(a===D-1||this.blends[a+1]<=.4)&&(this.blends[a]=Math.max(0,l-s))}r&&this.allOutAt===1/0&&this.blends.every(a=>a>=1)&&(this.allOutAt=i)}updateSpread(e){let t=1-Math.exp(-e/to);for(let i=0;i<D;i++)this.blends[i]<=0||(this.offsets[i]+=(this.slotAngle(i)-this.offsets[i])*t)}slotAngle(e){let t=Math.max(1,this.blends.filter(i=>i>0).length);return sn*Math.min(e,t-1)/t}baseAngleAt(e){let t=-sn*(e-this.enterAt)/this.orbitPeriodMs;if(this.allOutAt!==1/0){let i=ut((e-this.allOutAt-an)/cn);t-=sn*de(i)}return t}reenterStart(){return this.allOutAt+an+cn}miniSample(e,t){let i=this.blends[e];if(i<=0)return;let r=ee(i),o=Kr*q(i);if(this.allOutAt!==1/0){let c=this.reenterStart()+e*Zn,l=se(ut((t-c)/Kn));if(l>=1)return;r*=1-l,o*=1-l}let s=this.baseAngleAt(t)+this.offsets[e],a=Math.sin(s)*Wn*r;return{position:{x:Math.cos(s)*Wn*r,y:a*Math.cos(Xn),z:a*Math.sin(Xn)},scale:o}}centerScale(e,t){if(this.allOutAt!==1/0){let i=ut((e-this.reenterStart()-Yn)/no);if(i>=1)return this.finished=!0,0;if(i>0)return Hn*(i<.35?1+.18*he(i/.35):1.18*(1-oe((i-.35)/.65)))}return Hn*q(ut(t/$r))}};function pt(n={}){let e=(n.size??2.4)/2,t=n.periodMs??4e3,i=n.tilt??.45,r=n.direction??1,o=Math.cos(i),s=Math.sin(i);return{positionAt(a){let c=r*a/t,l=(c-Math.floor(c))*4,u=Math.floor(l),p=l-u,d,h;return u===0?(d=-e+2*e*p,h=-e):u===1?(d=e,h=-e+2*e*p):u===2?(d=e-2*e*p,h=e):(d=-e,h=e-2*e*p),{x:d,y:h*o,z:h*s}}}}var ge=50,ti=3,ni=55*Math.PI/180,$n=Math.tan(ni/2)*ti,oo=130,Jn=320,so=8,ao=.4*Math.PI/180,co=4e3,lo=1e3,ei=1200,uo={mode:"two-sided",opacity:.275},po=["#bae6fd","#7dd3fc","#38bdf8","#0ea5e9","#a5f3fc","#e0f2fe"],ho={emissive:[.1,.2,.3]},mo={x:0,y:1,z:0};function fo(n){return Math.max(0,Math.min(1,n))}function bo(n){let e=g(n),t=T(e,mo);Math.hypot(t.x,t.y,t.z)<1e-4&&(t={x:0,y:0,z:1}),t=g(t);let i=T(t,e),r=g(T(e,i));return{x:Math.atan2(T(r,e).z,r.z),y:Math.asin(Math.max(-1,Math.min(1,-e.z))),z:Math.atan2(e.y,e.x)}}function yo(n,e,t){let i=g(n),r=g(e),o=Math.max(-1,Math.min(1,W(i,r))),s=Math.acos(o);if(s<=t||s<1e-4)return r;let a=Math.sin(s);if(a<1e-4)return r;let c=t/s,l=Math.sin((1-c)*s)/a,u=Math.sin(c*s)/a;return g({x:i.x*l+r.x*u,y:i.y*l+r.y*u,z:i.z*l+r.z*u})}var Ie=class{constructor(e={}){this.cars=[];this.appear=new Array(ge).fill(0);this.headings=new Array(ge).fill(void 0);this.aspect=16/9;this.enterAt=1/0;this.outroAt=1/0;this.carsAtOutro=0;this.exitPathTime=0;this.exitPoint={x:0,y:0,z:0};this.exitDir={x:1,y:0,z:0};this.exitSpeed=.001;this.lastNow=0;this.finished=!1;this.motion=e.motion??pt({size:1.7,periodMs:6800,tilt:.5}),this.size=e.size??.15,this.backend=e.backend,this.labelContent=e.label,this.fadeLabel=e.fadeLabel??!0}mount(e){e.style.position||(e.style.position="relative");let t=new E({backend:this.backend,camera:{position:{x:0,y:0,z:ti},fov:ni}}),i=te(1,po,ho);for(let o=0;o<ge;o++)this.cars.push(t.add(i,{scale:0,transparency:{...uo}}));this.engine=t,t.mount(e).catch(o=>{e.textContent=o instanceof Error?o.message:String(o)});let r=()=>{e.clientWidth>0&&e.clientHeight>0&&(this.aspect=e.clientWidth/e.clientHeight)};r(),this.observer=new ResizeObserver(r),this.observer.observe(e),this.label=K(e,this.labelContent),this.fadeLabel&&this.label.setOpacity(0)}enter(e){this.enterAt===1/0&&(this.enterAt=e)}exit(e){if(this.outroAt!==1/0||this.enterAt===1/0)return;this.outroAt=e,this.carsAtOutro=this.appear.filter(o=>o>.5).length,this.exitPathTime=e-this.enterAt;let t=this.motion.positionAt(this.exitPathTime),i=S(this.motion.positionAt(this.exitPathTime+1),this.motion.positionAt(this.exitPathTime-1)),r=Math.hypot(i.x,i.y,i.z);this.exitPoint=t,r>1e-6&&(this.exitSpeed=r/2),this.exitDir=r>1e-6?g(i):{x:1,y:0,z:0}}isFinished(){return this.finished}get outroDurationMs(){return ei}trailEmitter(){return{positionAt:e=>this.enterAt===1/0?this.motion.positionAt(e):this.pathPosition(e-this.enterAt+this.warp(e))}}render(e,t){if(!this.engine||!this.label)return;for(let c of this.cars)c.transform.scale=0;if(this.enterAt===1/0){this.engine.render();return}let i=this.lastNow===0?16:Math.min(50,e-this.lastNow);this.lastNow=e;let r=this.outroAt!==1/0?this.carsAtOutro:Math.min(ge,Math.round(t.progress*ge)),o=$n*this.aspect,s=this.warp(e),a=!1;for(let c=0;c<ge;c++){let l=c<r?1:0;if(this.appear[c]=fo(this.appear[c]+Math.sign(l-this.appear[c])*(i/Jn)),this.appear[c]<=0){this.headings[c]=void 0;continue}let u=e-this.enterAt-c*oo+s,p=this.pathPosition(u);if(Math.abs(p.x)>o+this.size||Math.abs(p.y)>$n+this.size)continue;let d=S(this.pathPosition(u+so),p),h=Math.hypot(d.x,d.y,d.z)>1e-5?d:this.headings[c]??{x:1,y:0,z:0};this.headings[c]=this.headings[c]?yo(this.headings[c],h,ao*i):g(h);let m=bo(this.headings[c]),b=this.cars[c].transform;b.position.x=p.x,b.position.y=p.y,b.position.z=p.z,b.rotation.x=m.x,b.rotation.y=m.y,b.rotation.z=m.z,b.scale=this.size*q(this.appear[c]),a=!0}this.label.setText(t.indeterminate?typeof this.labelContent=="string"?this.labelContent:"":`${Math.round(t.progress*100)}%`),this.fadeLabel&&this.label.setOpacity(Q(e,this.enterAt,Jn,this.outroAt,ei)),this.outroAt!==1/0&&e>this.outroAt+300&&(!a||e>=this.outroAt+co)&&(this.finished=!0),this.engine.render()}destroy(){this.observer?.disconnect(),this.observer=void 0,this.label?.container.remove(),this.label=void 0,this.engine?.destroy(),this.engine=void 0,this.cars.length=0}warp(e){if(this.outroAt===1/0)return 0;let t=(e-this.outroAt)/1e3;return .5*lo*t*t}pathPosition(e){if(this.outroAt===1/0||e<=this.exitPathTime)return this.motion.positionAt(e);let t=this.exitSpeed*(e-this.exitPathTime);return{x:this.exitPoint.x+this.exitDir.x*t,y:this.exitPoint.y+this.exitDir.y*t,z:this.exitPoint.z+this.exitDir.z*t}}};var dt=5,R=dt*dt,ii=4,ri=55*Math.PI/180,ae=Math.PI*2,ci=900,li=60,xo=(R-1)*li+ci,Mo=.35,go=.65,vo=2.5,Ao=2e3,oi=380,Oo=80,To=1e3,ze=700,So=500,si=170,Po=600,Eo=["#8397c6","#7186b8","#6176a8","#93a6cf","#556a9c","#7a8fc0"],Lo=[()=>te(1,Eo)];function ht(n){return Math.max(0,Math.min(1,n))}function Io(n){let e=ht(n);return e*e*(3-2*e)}function zo(n){return typeof n=="function"?n():n}function ai(n){let e=n-ae*Math.floor(n/ae);return e>Math.PI?e-ae:e}function Ce(n,e){let t=(Math.imul(n+1,2654435769)^Math.imul(e+1,2246822507))>>>0;return t=Math.imul(t^t>>>16,73244475),t^=t>>>16,(t>>>0)/4294967296}var Re=class{constructor(e={}){this.handles=[];this.blends=new Array(R).fill(0);this.dockedAt=new Array(R).fill(1/0);this.tumbleX=[];this.tumbleY=[];this.collapseDelay=[];this.popStarted=new Array(R).fill(!1);this.maxCollapseDelay=0;this.fades=[];this.slots=[];this.aspect=16/9;this.enterAt=1/0;this.exitAt=1/0;this.allDockedAt=1/0;this.collapseAt=1/0;this.lastNow=0;this.finished=!1;let t=e.meshes&&e.meshes.length>0?e.meshes:Lo;this.meshes=t.map(zo),this.size=e.size??.34,this.orbitPeriodMs=e.orbitPeriodMs??9e3,this.dockMs=e.dockMs??800,this.backend=e.backend,this.labelContent=e.label,this.fadeLabel=e.fadeLabel??!0;let i=this.size+(e.gap??.12);for(let r=0;r<R;r++){let o=Math.floor(r/dt),s=r%dt;this.slots.push({x:(s-2)*i,y:(2-o)*i,z:0}),this.tumbleX.push(ae*Ce(r,2)-Math.PI),this.tumbleY.push(ae*Ce(r,4)-Math.PI),this.collapseDelay.push(Ce(r,7)*So)}this.maxCollapseDelay=Math.max(...this.collapseDelay)}mount(e){e.style.position||(e.style.position="relative");let t=new E({backend:this.backend,camera:{position:{x:0,y:0,z:ii},fov:ri}});for(let r=0;r<R;r++)this.fades.push({mode:"one-sided",opacity:1}),this.handles.push(t.add(this.meshes[r%this.meshes.length],{scale:0}));this.engine=t,t.mount(e).catch(r=>{e.textContent=r instanceof Error?r.message:String(r)});let i=()=>{e.clientWidth>0&&e.clientHeight>0&&(this.aspect=e.clientWidth/e.clientHeight)};i(),this.observer=new ResizeObserver(i),this.observer.observe(e),this.label=K(e,this.labelContent),this.fadeLabel&&this.label.setOpacity(0)}enter(e){this.enterAt===1/0&&(this.enterAt=e)}exit(e){this.exitAt===1/0&&(this.exitAt=e)}isFinished(){return this.finished}render(e,t){if(!this.engine||!this.label)return;if(this.enterAt===1/0){for(let r of this.handles)r.transform.scale=0;this.engine.render();return}let i=this.lastNow===0?16:Math.min(50,e-this.lastNow);this.lastNow=e,this.updateBlends(i,t.progress,e),this.exitAt!==1/0&&this.allDockedAt!==1/0&&this.collapseAt===1/0&&(this.collapseAt=Math.max(this.exitAt,this.allDockedAt)+To),e>=this.collapseAt?this.renderCollapse(e):this.renderStory(e,i),this.label.setText(t.indeterminate?typeof this.labelContent=="string"?this.labelContent:"":`${Math.round(t.progress*100)}%`),this.fadeLabel&&this.label.setOpacity(Q(e,this.enterAt,Po,this.collapseAt,ze)),this.collapseAt!==1/0&&e>=this.collapseAt+this.maxCollapseDelay+ze+si&&(this.finished=!0),this.engine.render()}destroy(){this.observer?.disconnect(),this.observer=void 0,this.label?.container.remove(),this.label=void 0,this.engine?.destroy(),this.engine=void 0,this.handles.length=0,this.fades.length=0}updateBlends(e,t,i){let r=this.exitAt!==1/0,s=i-this.enterAt>=xo?r?R:Math.min(R,Math.floor(t*R+1e-9)):0,a=e/this.dockMs*(r?vo:1);for(let l=0;l<R;l++){let u=l<s?1:0,p=this.blends[l];u>p&&(l===0||this.blends[l-1]>=Mo)?this.blends[l]=Math.min(1,p+a):u<p&&(l===R-1||this.blends[l+1]<=go)&&(this.blends[l]=Math.max(0,p-a)),this.blends[l]>=1?this.dockedAt[l]===1/0&&(this.dockedAt[l]=i):this.dockedAt[l]=1/0}s===R&&this.blends.every(l=>l>=1)?this.allDockedAt===1/0&&(this.allDockedAt=i):r||(this.allDockedAt=1/0)}renderStory(e,t){let i=e-this.enterAt,r=Math.tan(ri/2)*ii,o=r*this.aspect,s=Math.max(.6,Math.min(o,r)-this.size*.55),a=(Math.max(o,r)*1.25+this.size*2)/s;for(let c=0;c<R;c++){let l=this.handles[c].transform,u=Io(this.blends[c]),p=ht((i-c*li)/ci),d=1+(a-1)*(1-ee(p)),h=Math.PI/2-c/R*ae-i/this.orbitPeriodMs*ae,m=Math.cos(h)*s*d,b=Math.sin(h)*s*d,f=this.slots[c];if(l.position.x=m+(f.x-m)*u,l.position.y=b+(f.y-b)*u,l.position.z=0,l.scale=this.size,this.blends[c]===0&&(this.tumbleX[c]=ai(this.tumbleX[c]+(4e-4+8e-4*Ce(c,1))*t),this.tumbleY[c]=ai(this.tumbleY[c]+(6e-4+.001*Ce(c,3))*t)),l.rotation.z=0,this.blends[c]>=1){let y=(i+c*Oo)%Ao,M=y<oi&&e-y>=this.dockedAt[c];l.rotation.x=0,l.rotation.y=M?ae*de(y/oi):0}else{let y=1-u;l.rotation.x=this.tumbleX[c]*y,l.rotation.y=this.tumbleY[c]*y}}}renderCollapse(e){this.captured||(this.captured=this.handles.map(t=>({...t.transform.position})));for(let t=0;t<R;t++){let i=this.handles[t].transform,r=this.captured[t],o=e-this.collapseAt-this.collapseDelay[t];if(o<=0){i.position.x=r.x,i.position.y=r.y,i.position.z=r.z,i.scale=this.size;continue}let s=se(ht(o/ze));if(i.position.x=r.x*(1-s),i.position.y=r.y*(1-s),i.position.z=r.z*(1-s),i.scale=this.size*(1-.99*s),o>=ze){this.popStarted[t]||(this.popStarted[t]=!0,this.handles[t].transparency=this.fades[t]);let a=ht((o-ze)/si);this.fades[t].opacity=1-a,i.scale=a>=1?0:this.size*.01*(1+1.6*Math.sin(Math.PI*a))}}}};var w=20,xi=3,Mi=55*Math.PI/180,ui=Math.tan(Mi/2)*xi,we=.12,Fe=-.5,pi=.3,hi=460,di=.45,Co=2.5,ln=620,Ro=5.2,wo=2e3,Fo=3,mi=.2,_o=.8,fi=30,Vo=50,ko=Math.PI/180,un=1400,Do=320,jo=.55,Bo=.17,Uo=.16,Go=104,pn=420,No=55,Ho=950,bi=.25,Wo=.09,Xo=.15,Yo=.9,qo=140,Qo=["#e2e8f0","#cbd5e1"],Ko=["#fef3c7","#fde047","#fb923c","#ef4444"],Zo=["#e2e8f0","#f8fafc","#cbd5e1","#94a3b8","#e2e8f0"];function $o(n){return Math.max(0,Math.min(1,n))}function _e(n,e,t){let i=$o((t-n)/(e-n));return i*i*(3-2*i)}function j(n,e){let t=(Math.imul(n+1,2654435769)^Math.imul(e+1,2246822507))>>>0;return t=Math.imul(t^t>>>16,73244475),t^=t>>>16,(t>>>0)/4294967296}function yi(n,e){return ne(t=>{let i=t.createRadialGradient(48,48,1,48,48,47);i.addColorStop(0,`rgba(255,255,255,${n})`),i.addColorStop(e,`rgba(255,255,255,${n*.6})`),i.addColorStop(1,"rgba(255,255,255,0)"),t.fillStyle=i,t.fillRect(0,0,96,96)})}var Ve=class{constructor(e={}){this.rockets=[];this.smoke=[];this.fire=[];this.smokeFades=[];this.fireFades=[];this.blends=new Array(w).fill(0);this.groundedAt=new Array(w).fill(1/0);this.turnS=new Array(w).fill(1/0);this.turnDir=[];this.turnRoll=new Array(w).fill(0);this.stagger=new Array(w).fill(0);this.aspect=16/9;this.enterAt=1/0;this.exitAt=1/0;this.launchedAt=1/0;this.lastNow=0;this.finished=!1;this.backend=e.backend,this.labelContent=e.label,this.fadeLabel=e.fadeLabel??!0;for(let i=0;i<w;i++)this.turnDir.push({x:0,y:1}),this.stagger[i]=j(i,7)*ln;let t=Array.from({length:w},(i,r)=>r).sort((i,r)=>j(i,11)-j(r,11));for(let i of t.slice(0,Fo)){let r=mi+j(i,12)*(_o-mi),o=(fi+j(i,13)*(Vo-fi))*ko,s=j(i,14)<.5?-1:1;this.turnS[i]=r-Fe,this.turnDir[i]={x:s*Math.sin(o),y:Math.cos(o)},this.turnRoll[i]=-s*o}}mount(e){e.style.position||(e.style.position="relative");let t=Qo.map(u=>pe(1,[u])),i=Ko.map(u=>pe(1,[u])),r=yi(.85,.5),o=yi(1,.32),s=async u=>{let p=this.backend==="webgpu"?new(await Promise.resolve().then(()=>(ot(),nn))).WebGPUTexturedRenderer(u):this.backend==="webgl"?new(await Promise.resolve().then(()=>(at(),rn))).WebGLTexturedRenderer(u):new(await Promise.resolve().then(()=>(lt(),on))).Canvas2DTexturedRenderer(u);for(let d of t)p.setTexture(d,r);for(let d of i)p.setTexture(d,o);return p},a=new E({backend:s,camera:{position:{x:0,y:0,z:xi},fov:Mi}}),c=qe(1,Zo);for(let u=0;u<w;u++)this.rockets.push(a.add(c,{scale:0}));for(let u=0;u<Go;u++){let p={mode:"one-sided",opacity:0};this.smokeFades.push(p),this.smoke.push(a.add(t[u%t.length],{scale:0,transparency:p}))}for(let u=0;u<qo;u++){let p={mode:"one-sided",opacity:0};this.fireFades.push(p),this.fire.push(a.add(i[u%i.length],{scale:0,transparency:p}))}this.engine=a,a.mount(e).catch(u=>{e.textContent=u instanceof Error?u.message:String(u)});let l=()=>{e.clientWidth>0&&e.clientHeight>0&&(this.aspect=e.clientWidth/e.clientHeight)};l(),this.observer=new ResizeObserver(l),this.observer.observe(e),this.label=K(e,this.labelContent),this.fadeLabel&&this.label.setOpacity(0)}enter(e){this.enterAt===1/0&&(this.enterAt=e)}exit(e){this.exitAt===1/0&&(this.exitAt=e)}isFinished(){return this.finished}render(e,t){if(!this.engine||!this.label)return;for(let p of this.rockets)p.transform.scale=0;for(let p of this.smokeFades)p.opacity=0;for(let p of this.fireFades)p.opacity=0;for(let p of this.smoke)p.transform.scale=0;for(let p of this.fire)p.transform.scale=0;if(this.enterAt===1/0){this.engine.render();return}let i=this.lastNow===0?16:Math.min(50,e-this.lastNow);this.lastNow=e;let r=this.exitAt!==1/0;this.updateBlends(i,t.progress,e,r),r&&this.launchedAt===1/0&&this.blends.every(p=>p>=1)&&(this.launchedAt=e);let o=this.launchedAt!==1/0,s=ui*this.aspect,a=Math.min(s*.8,1.18),c=s+.6,l=0,u=0;for(let p=0;p<w;p++){let d=-a+2*a*p/(w-1),h=o?this.launchedAt+this.stagger[p]:1/0,m=e-h;if(o&&m>=0){this.renderAscent(p,d,m,s),u=this.emitFire(p,d,m,u);continue}let b=this.blends[p];if(b<=0)continue;let f=this.rockets[p].transform;f.position.x=c+(d-c)*q(b),f.position.y=Fe,f.position.z=0,f.rotation.x=0,f.rotation.y=0,f.rotation.z=0,f.scale=we*_e(0,.6,b),this.groundedAt[p]!==1/0&&(l=this.emitSmoke(p,d,e,h,l))}this.label.setText(t.indeterminate?typeof this.labelContent=="string"?this.labelContent:"":`${Math.round(t.progress*100)}%`),this.fadeLabel&&this.label.setOpacity(Q(e,this.enterAt,hi,this.launchedAt,ln)),o&&e>=this.launchedAt+ln+wo&&(this.finished=!0),this.engine.render()}destroy(){this.observer?.disconnect(),this.observer=void 0,this.label?.container.remove(),this.label=void 0,this.engine?.destroy(),this.engine=void 0,this.rockets.length=0,this.smoke.length=0,this.fire.length=0,this.smokeFades.length=0,this.fireFades.length=0}updateBlends(e,t,i,r){let o=r?w:Math.min(w,Math.round(t*w)),s=e/hi*(r?Co:1);for(let a=0;a<w;a++){let c=a<o?1:0,l=this.blends[a];c>l&&(a===0||this.blends[a-1]>=di)?this.blends[a]=Math.min(1,l+s):c<l&&(a===w-1||this.blends[a+1]<=1-di)&&(this.blends[a]=Math.max(0,l-s)),this.blends[a]>=1?this.groundedAt[a]===1/0&&(this.groundedAt[a]=i):this.groundedAt[a]=1/0}}ascentDistance(e){let t=e/1e3;return .5*Ro*t*t}ascentPose(e,t,i){let r=this.ascentDistance(i),o=this.turnS[e];if(r<=o)return{pos:{x:t,y:Fe+r},dir:{x:0,y:1},roll:0};let s=r-o,a=this.turnDir[e];return{pos:{x:t+a.x*s,y:Fe+o+a.y*s},dir:a,roll:this.turnRoll[e]}}renderAscent(e,t,i,r){let{pos:o,roll:s}=this.ascentPose(e,t,i);if(o.y>ui+.4||Math.abs(o.x)>r+.4)return;let a=this.rockets[e].transform;a.position.x=o.x,a.position.y=o.y,a.position.z=0,a.rotation.x=0,a.rotation.y=0,a.rotation.z=s,a.scale=we}emitFire(e,t,i,r){let o=No,s=Math.min(Math.floor(i/o),Math.floor(Ho/o)),a=Math.max(0,Math.ceil((i-pn)/o));for(let c=a;c<=s;c++){if(r>=this.fire.length)return r;let l=c*o,u=i-l;if(u<0||u>=pn)continue;let p=u/pn,d=u/1e3,h=this.ascentPose(e,t,l),m={x:-h.dir.x,y:-h.dir.y},b={x:-h.dir.y,y:h.dir.x},f=(j(e*97+c,1)-.5)*Wo,y=h.pos.x+m.x*we*.5,M=h.pos.y+m.y*we*.5,x=this.fire[r].transform;x.position.x=y+m.x*bi*d+b.x*f,x.position.y=M+m.y*bi*d+b.y*f-.12*d*d,x.position.z=pi,x.rotation.z=j(e*97+c,2)*Math.PI*2,x.scale=Xo*(.7+.5*j(e*97+c,3))*(1-.55*p),this.fireFades[r].opacity=Yo*_e(0,.15,p)*(1-_e(.55,1,p)),r++}return r}emitSmoke(e,t,i,r,o){let s=this.groundedAt[e],a=i-s,c=Do,l=Number.isFinite(r)?r-s:a,u=Math.min(Math.floor(a/c),Math.floor(l/c)),p=Math.max(0,Math.ceil((a-un)/c)),d=Fe-we*.4;for(let h=p;h<=u;h++){if(o>=this.smoke.length)return o;let m=a-h*c;if(m<0||m>=un)continue;let b=m/un,f=(j(e*131+h,1)-.5)*.14,y=this.smoke[o].transform;y.position.x=t+f*b,y.position.y=d+jo*b,y.position.z=pi,y.rotation.z=j(e*131+h,2)*Math.PI*2,y.scale=Bo*(.5+.8*b)*(.7+.6*j(e*131+h,3)),this.smokeFades[o].opacity=Uo*_e(0,.25,b)*(1-_e(.5,1,b)),o++}return o}};var H=class{constructor(e){this.elements=[];this.layers=e.map(t=>"animation"in t?t:{animation:t})}mount(e){e.style.position="relative";for(let[t,i]of this.layers.entries()){let r=document.createElement("div");r.style.cssText=`position:absolute;inset:0;z-index:${i.zIndex??t}`,e.appendChild(r),this.elements.push(r),i.animation.mount(r)}}enter(e){for(let t of this.layers)t.animation.enter(e)}exit(e){for(let t of this.layers)t.animation.exit(e)}render(e,t){for(let i of this.layers)i.animation.render(e,t)}isFinished(){return this.layers.every(e=>e.animation.isFinished())}destroy(){for(let e of this.layers)e.animation.destroy();for(let e of this.elements)e.remove();this.elements.length=0}};function Z(n,e){return{type:"indeterminate",animation:n,loop:e.loop,periodMs:e.periodMs}}function ce(n,e){return{type:"progress",animation:n,progress:e.progress??.001,timeout:e.timeout,until:e.until}}function gi(n={}){let e=n.particles??{},t=e.rate??60,i=new Le({backend:n.backend,...n.orb}),r=new L({rate:t,lifeMs:1200,size:.12,speed:.05,colors:["#ffffff","#a5f3fc","#818cf8"],texture:e.texture??re(),emitter:i.satelliteEmitter(1e3/t),outroMs:i.outroEmitMs,seed:5,backend:n.backend,...e,label:n.label??e.label,fadeLabel:n.fadeLabel??e.fadeLabel});return ce(new H([i,r]),n)}function ve(n={}){let e=n.size??1,t=n.periodMs??3600;return{positionAt(i){let r=i/t*Math.PI*2;return{x:e*1.5*Math.sin(r),y:e*1*Math.sin(r)*Math.cos(r),z:e*1.05*Math.cos(r)}}}}function vi(n={}){let e=n.object?.motion??ve({size:.66,periodMs:7200}),t=n.particles??{},i=new me({mesh:()=>Ye(1,["#f0f9ff","#7dd3fc","#818cf8","#e879f9"]),motion:e,size:.42,rotation:{spinX:.002,spinY:.003},backend:n.backend,...n.object,label:n.object?.label}),r=new H([new L({rate:44,lifeMs:2300,size:.25,speed:.08,colors:["#ffffff","#bae6fd","#818cf8"],texture:t.texture??re(),emitter:i.trailEmitter(),outroMs:i.outroDurationMs,seed:28,backend:n.backend,...t,label:n.label??t.label??"Polishing pixels",fadeLabel:n.fadeLabel??t.fadeLabel}),i]);return Z(r,n)}function Ai(n={}){let e=n.particles??{},t=new Ie({backend:n.backend,...n.train}),i=new L({rate:30,lifeMs:1700,size:.15,speed:.11,colors:["#e0f2fe","#a5f3fc","#c4b5fd"],texture:e.texture??ie({glow:5}),emitter:t.trailEmitter(),outroMs:t.outroDurationMs,seed:17,backend:n.backend,...e,label:n.label??e.label,fadeLabel:n.fadeLabel??e.fadeLabel});return ce(new H([i,t]),n)}function Oi(n={}){return ce(new Re({backend:n.backend,label:n.label,fadeLabel:n.fadeLabel,...n.assembly}),n)}function Ti(n={}){let e=n.particles??{};return Z(new L({rate:70,lifeMs:2800,size:.38,speed:1.35,direction:{x:0,y:1,z:0},spread:.62,gravity:{x:0,y:-1.45,z:0},colors:["#fff","#000"],texture:e.texture??Ke(),spin:0,alignToMotion:!0,seed:37,backend:n.backend,...e,label:n.label??e.label??"Loading...",fadeLabel:n.fadeLabel??e.fadeLabel}),n)}function Si(n={}){let e=n.object?.motion??ve({size:.72,periodMs:6200}),t=n.particles??{},i=new me({mesh:Qe,motion:e,size:.48,backend:n.backend,...n.object,label:n.object?.label}),r=new H([new L({rate:34,lifeMs:1900,size:.16,speed:.11,colors:["#fde047","#f472b6","#7dd3fc"],texture:t.texture??ie(),emitter:i.trailEmitter(),outroMs:i.outroDurationMs,seed:11,backend:n.backend,...t,label:n.label??t.label??"Flying in...",fadeLabel:n.fadeLabel??t.fadeLabel}),i]);return Z(r,n)}function Jo(){let n=document.createElement("div");return n.innerHTML=`<style>
    @keyframes spinner-prefab-pulse { 0%,100% { color:#fff; transform:scale(1); } 50% { color:#93c5fd; transform:scale(1.06); } }
  </style><div style="animation:spinner-prefab-pulse 2.4s ease-in-out infinite;font-size:2rem">Loading the good stuff</div>`,n}function Pi(n={}){let e=n.particles??{};return Z(new L({rate:48,lifeMs:4200,size:.3,speed:.34,colors:["#ffffff","#dbeafe","#93c5fd","#c4b5fd"],texture:e.texture??re(),seed:71,backend:n.backend,...e,label:n.label??e.label??Jo(),fadeLabel:n.fadeLabel??e.fadeLabel}),n)}function Ei(n={}){return ce(new Ve({backend:n.backend,label:n.label,fadeLabel:n.fadeLabel}),n)}function es(n){let e=n>>>0;return()=>{e=e+1831565813|0;let t=Math.imul(e^e>>>15,1|e);return t=t+Math.imul(t^t>>>7,61|t)^t,((t^t>>>14)>>>0)/4294967296}}function hn(n,e,t){let i=[0,1,2].map(()=>({freq:.5+n()*1.4,phase:n()*Math.PI*2,weight:.5+n()})),r=i.reduce((o,s)=>o+s.weight,0);return o=>{let s=0;for(let a of i)s+=a.weight*Math.sin(e*a.freq*o+a.phase);return s/r*t}}function mt(n={}){let e=n.bounds?.x??1.4,t=n.bounds?.y??1,i=n.bounds?.z??.6,r=n.periodMs??9e3,o=n.seed??Math.random()*1e9|0,s=es(o),a=2*Math.PI/r,c=hn(s,a,e),l=hn(s,a,t),u=hn(s,a,i);return{positionAt(p){return{x:c(p),y:l(p),z:u(p)}}}}function Li(n={}){let e=n.particles??{},t=e.emitter??mt({bounds:{x:1.1,y:.72,z:.35},periodMs:7200,seed:19});return Z(new L({rate:38,lifeMs:2600,size:.15,speed:.17,colors:["#fef08a","#f9a8d4","#a5f3fc"],texture:e.texture??ie(),emitter:t,seed:91,backend:n.backend,...e,label:n.label??e.label??"Loading...",fadeLabel:n.fadeLabel??e.fadeLabel}),n)}function Ii(n={}){let e=n.radius??1.3,t=n.periodMs??3e3,i=n.tilt??.5,r=n.direction??1,o=Math.cos(i),s=Math.sin(i);return{positionAt(a){let c=r*a/t*Math.PI*2,l=e*Math.cos(c),u=e*Math.sin(c);return{x:l,y:u*o,z:u*s}}}}at();lt();ot();var ts=["#3b82f6","#8b5cf6","#ec4899","#f59e0b","#10b981","#ef4444"];function ft(n){return Math.min(1,Math.max(0,n))}function ns(n){let e=Number.parseFloat(n);if(Number.isFinite(e))return Math.round(ft(e)*255).toString(16).padStart(2,"0")}function zi(n){let e=n.slice(1,4).map(Number.parseFloat);if(!(e.length!==3||!e.every(Number.isFinite)))return[ft(e[0]),ft(e[1]),ft(e[2])]}function is(n){let e={};return n.specular&&(e.specular=n.specular),n.shininess!==void 0&&(e.shininess=n.shininess),n.emissive&&(e.emissive=n.emissive),Object.keys(e).length>0?e:void 0}function rs(n){let e=new Map,t=new Map,i;for(let r of n.split(`
