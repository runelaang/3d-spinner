...
export declare function webgpu(): Gpu | undefined;
/** The WebGPU flag constants from the browser globals. Call only where WebGPU exists. */
export declare function gpuFlags(): GpuFlags;
/** The WebGPU context of `canvas`, or `null` when it cannot provide one. */
export declare function webgpuContext(canvas: HTMLCanvasElement): GpuCanvasContext | null;
export {};
