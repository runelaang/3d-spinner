...
import { type Backend, type Material, type Mesh, type Transparency } from "../engines/little-3d-engine/little-3d-engine.cjs";
import { type ProgressAnimationOptions } from "../progress-animation.cjs";
