...
import { ChargedOrbAnimation, type ChargedOrbOptions } from "../animations/charged-orb.js";
 ...
 */
export function chargedOrb(options: ChargedOrbPrefabOptions = {}): ProgressSpinnerOptions {
