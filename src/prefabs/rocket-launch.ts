...
import type { ObjectMotionTransition } from "../motion/transitions.js";
...
const launchUp: ObjectMotionTransition = ({ delta, position, velocity, durationMs }) => {
 ...
 */
export function rocketLaunch(options: MotionProgressPrefabOptions = {}): ProgressSpinnerOptions {
