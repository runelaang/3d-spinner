...
function objError(line: number, message: string): never {
...
function parseVertex(parts: string[], line: number): Mesh["vertices"][number] {
...
function resolveIndex(token: string, vertexCount: number, line: number): number {
